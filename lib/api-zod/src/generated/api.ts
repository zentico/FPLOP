...
export const ListSolvesResponseItem = zod.object({
  ...
  "bankBefore": zod.number().nullish().describe('Bank balance available before this gameweek\'s transfers'),
  "bank": zod.number().nullish().describe('Bank balance remaining after this gameweek\'s transfers'),
  "freeTransfers": zod.number().nullish().describe('Free transfers available going into this gameweek'),
  "freeTransfersAfter": zod.number().nullish().describe('Free transfers carried into the following gameweek after this game\'s moves'),
