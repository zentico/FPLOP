              ...
              {!firstGameweek && (
                <div className="space-y-3 animate-in fade-in slide-in-from-top-2">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    />
                    {isLoadingTeam && isTeamIdValid ? (
                      <span className="text-sm text-muted-foreground animate-pulse">
                        Looking up team…
                      </span>
                    ) : teamData ? (
                      <div className="min-w-0 rounded-md border bg-primary/5 px-3 py-2 leading-tight">
                        <div className="font-semibold truncate">{teamData.name}</div>
                ...
                {showAdvanced && (
                  <div className="space-y-5 animate-in fade-in">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <AdvField label="Optimality gap" placeholder="0.002" hint="e.g. 0.002 accepts within 0.2% of optimal; larger is faster" value={adv.gap || ""} onChange={(v) => setAdv({ ...adv, gap: v })} />
